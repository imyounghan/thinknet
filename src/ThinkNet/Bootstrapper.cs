...
namespace ThinkNet
{
    ...
    public class Bootstrapper
    {
        ...
        private void RegisterDefaultComponents()
        {
            ...
            this.SetDefault<IMessageReceiver<Envelope<Command>>, CommandProducer>();
            ...
            this.SetDefault<ISendReplyService, NonReplyService>();
        ...
        private static bool IsMessageHandlerInterfaceType(Type genericType)
        {
            return genericType == typeof(IMessageHandler<>) ||
                genericType == typeof(IEnvelopedMessageHandler<>) ||
