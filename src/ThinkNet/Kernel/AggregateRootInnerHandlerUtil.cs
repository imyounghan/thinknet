...
{
    public static class AggregateRootInnerHandlerUtil
    {
        private readonly static ConcurrentDictionary<Type, IDictionary<Type, MethodInfo>> _innerHandlers = new ConcurrentDictionary<Type, IDictionary<Type, MethodInfo>>();
