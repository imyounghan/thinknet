...
namespace ThinkNet.Messaging
{
    ...
    public interface IEventStore
    {
        ...
        bool Save(SourceInfo sourceInfo, EventCollection eventCollection);
        ...
        EventCollection Find(SourceInfo sourceInfo, string correlationId);
        ...
        IEnumerable<EventCollection> FindAll(SourceInfo sourceInfo, int startVersion);
    }
}
