...
namespace ThinkNet.Messaging
{
    ...
    /// </summary>
    [Serializable]
    public struct SourceInfo : IEquatable<SourceInfo>, ISerializable
    {
        /// <summary>
        /// 空的主键
        /// </summary>
        ...
        /// Parameterized constructor.
        /// </summary>
        public SourceInfo(string sourceId, string sourceTypeName)
        {
        ...
        /// Parameterized constructor.
        /// </summary>
        public SourceInfo(string sourceId, string sourceNamespace, string sourceTypeName)
        ...
        bool IEquatable<SourceInfo>.Equals(SourceInfo other)
        {
