...
namespace ThinkNet.Messaging
{
    [DataContract]
    [Serializable]
    public class DomainEvent : Message, IEvent
    {
        [DataContract]
        [Serializable]
        public class Stream
        ...
        public DomainEvent(object sourceId, Type sourceType)
        ...
        public DomainEvent(string sourceId, string sourceNamespace, string sourceTypeName)
            : this(sourceId, sourceNamespace, sourceTypeName, string.Empty)
        { }

        public DomainEvent(string sourceId, string sourceNamespace, string sourceTypeName, string sourceAssemblyName)
            : this()
        {
