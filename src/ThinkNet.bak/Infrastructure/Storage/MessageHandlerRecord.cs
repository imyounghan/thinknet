...
namespace ThinkNet.Infrastructure.Storage
{
    ...
    public class MessageHandlerRecord
    {
        ...
        /// Default constructor.
        /// </summary>
        public MessageHandlerRecord()
        { }
        /// <summary>
        /// Parameterized constructor.
        /// </summary>
        public MessageHandlerRecord(string messageId, Type messageType, Type handlerType)
        {
        ...
        /// <summary>
        /// 确定此实例是否与指定的对象（也必须是 <see cref="MessageHandlerRecord"/> 对象）相同。
        /// </summary>
        public override bool Equals(object obj)
        {
            var other = obj as MessageHandlerRecord;
